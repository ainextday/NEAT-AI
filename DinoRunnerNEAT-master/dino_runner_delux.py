...
# กำหนด Path ของโฟลเดอร์ที่เก็บไฟล์ sprites
Path = os.path.dirname(os.path.abspath(__file__))

# โหลดภาพ
dino_art = [
    pg.image.load(os.path.join(Path, "sprites", "running_1.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "standing.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "running_2.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "jump.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "duck.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "duck_run_1.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "duck_run_2.png")).convert_alpha()
]

bg_art = pg.image.load(os.path.join(Path, "sprites", "bg.png")).convert()
ground_art = pg.image.load(os.path.join(Path, "sprites", "ground.png")).convert_alpha()

cacti_art = [
    pg.image.load(os.path.join(Path, "sprites", "cacti_1.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "cacti_2.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "cacti_3.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "cacti_4.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "cacti_5.png")).convert_alpha()
]

flying_dino = [
    pg.image.load(os.path.join(Path, "sprites", "fly_up.png")).convert_alpha(),
    pg.image.load(os.path.join(Path, "sprites", "fly_down.png")).convert_alpha()
]

# โหลดเสียง
death_sound = pg.mixer.Sound(os.path.join(Path, "audio", "death.wav"))
